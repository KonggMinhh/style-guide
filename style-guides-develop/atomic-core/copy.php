...
foreach ($cat_data as $cat_value) {
    ...
    <h1 id="modules" class="atomic-h1"><?php echo $_GET['cat']; ?> <a class="far fa-edit js_add-edit-component aa_js-actionOpen aa_actionBtn" href="atomic-core/temp-forms/temp-category-form.php">
        ...
        <div id="<?php echo $comp_value['comp_name'] ?>-container" class="compWrap">
            <p id="<?php echo $comp_value['comp_name'] ?>"
               class="content-editable compTitle">
                ...
                <a class="far fa-edit js_add-edit-component aa_js-actionOpen aa_actionBtn"
                   href="atomic-core/temp-forms/temp-component-form.php"
