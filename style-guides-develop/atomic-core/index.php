...
<div id="search-list" class="searchWindow">
    ...
    <div class="atoms-overflow">
        ...
        <i class="fal fa-times fa-3x js_searchWindow__close searchWindow__close"></i>
...
<div class="grid-row atoms-container editorMode">
    ...
    <aside class="atoms-side">
        <div class="atoms-overflow">
            ...
            <div class="logo">
                <img style="height:40px" src="https://logo.kiotviet.vn/KiotViet-Logo-Horizontal.svg">
            </div>
            ...
            <div class="atoms-side_hide">
                ...
                <a class="js-edit-settings navIcon navIcon-settings fas fa-cog aa_js-actionOpen aa_actionBtn"
            ...
            <nav>
                <ul class="atoms-nav">
                    ...
                    foreach ($categories as $category) {
                        ...
                        <div class="aa_dir__dirNameGroup">
                            <i class="aa_dir__dirNameGroup__icon  fal fa-folder"></i>
                ...
                <div class="catAdd"><a class="js_cat-add aa_js-actionOpen aa_actionBtn"
                            ...
                            class="fal fa-folder"></span> Add Category</a></div>
            </nav>
        ...
        <?php if (!empty($_GET['cat']) || !empty($_GET['search'])) { ?>
            ...
            <?php if (!empty($_GET['cat'])) { ?>
                <h1 id="modules" class="atomic-h1"><?php echo $_GET['cat']; ?> <a
                        class="js_cat-edit aa_js-actionOpen aa_actionBtn kv-btn kv-btn-icon-only kv-btn-text-gray"
            ...
            foreach ($compSelect as $component) {
                ...
                <div id="<?php echo $component['component'] ?>"
                   class="content-editable compTitle">
                    <h3><?php echo $component['component'] ?></h3>
                    <span class="js-hideAll kv-btn kv-btn-sm kv-btn-icon-only kv-btn-text-gray">
                        <i class="far fa-eye"></i>
                    </span>
                    <a class="js_edit-component aa_js-actionOpen aa_actionBtn kv-btn kv-btn-sm kv-btn-icon-only kv-btn-text-gray"
                ...
                <div class="compNotes"
                   data-description="<?php echo $component['description'] ?>"><?php echo $component['description'] ?></div>
                ...
                <div class="codeBlocks grid-row">
                    ...
                    <ul class="nav-atomic nav-tabs-atomic" role="tablist">
                        <li role="presentation" class="active"><a
                                ...
                                data-toggle="tab"><i class="fa fa-code" aria-hidden="true"></i> HTML</a></li>


                        <!-- <li role="presentation"><a
                                href="#<?php echo $component['component'] ?>-output-tab"
                                aria-controls="home" role="tab"
                                data-toggle="tab"><i class="far fa-eye" aria-hidden="true"></i> Output</a></li> -->


                        <li role="presentation"><a href="#<?php echo $component['component'] ?>-styles-tab"
                                                   aria-controls="profile"
                                                   role="tab" data-toggle="tab">{ } SCSS</a></li>
                        ...
                        <div role="tabpanel" class="tab-pane active"
                            ...
                            <form class="atomic-editorWrap" data-editorFormComp="<?php echo $component['component'] ?>"
                                ...
                                <div class="atomic-editor-footer">
                                    <button type="submit" class="atomic-btns atomic-btn1"><i class="fas fa-save" aria-hidden="true"></i> Save</button>
                                    <span type="reset" class="js-close-editor atomic-btns atomic-btn2"><i class="fas fa-ban" aria-hidden="true"></i> Cancel</span>
                                </div>
                            </form>
                        </div>
...
<div class="aa_js-actionDrawer aa_actionDrawer">
    <div class="aa_actionDrawer__wrap">
        <div class="aa_js-actionClose aa_actionDrawer__close"><i class="fal fa-times fa-3x"></i></div>
