...
$('.active .aa_dir__dirNameGroup__icon').removeClass('fa-folder').addClass('fa-folder-open');
...
$(document).ready(function() {
    ...
    // $(".kv-form-control").focus(function(){
    //     $(this).closest(".kv-form-control-wrapper").addClass("kv-form-control-wrapper-focused");
     
    //    }).blur(function(){
    //         $(this).closest(".kv-form-control-wrapper").removeClass("kv-form-control-wrapper-focused");
    //    }); 
